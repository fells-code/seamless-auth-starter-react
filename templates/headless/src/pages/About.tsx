    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black px-6 py-16">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            The React SDK manages auth state through `AuthProvider`. This
            template uses `useAuthClient`, `useAuth`, and `usePasskeySupport`
            to build custom screens without mounting `AuthRoutes`.
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc ml-6 text-gray-700 dark:text-gray-300 space-y-2">
            <li>Custom login and registration screens using headless hooks</li>
            <li>Passwordless authentication without SDK-owned route UI</li>
