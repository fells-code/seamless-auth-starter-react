    ...
    return (
      <div className="max-w-xl mx-auto space-y-6">
        ...
        <p className="text-gray-700 dark:text-gray-400">
          This template uses the Seamless Auth React SDK as a headless client.
          The forms, fallback choices, OTP prompts, and passkey registration
          screens are owned by the application.
        </p>
