      ...
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="space-y-6">
          ...
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            magic links, email OTP, phone OTP, and OAuth providers while
            keeping the auth server self-hostable and auditable.
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            The React SDK manages auth state through `AuthProvider`, built-in
            auth screens through `AuthRoutes`, and OAuth helpers through
            `listOAuthProviders`, `startOAuthLogin`, and `finishOAuthLogin`.
          </p>
        </section>
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc ml-6 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <li>Passkey sign-in and dynamic OAuth provider buttons</li>
